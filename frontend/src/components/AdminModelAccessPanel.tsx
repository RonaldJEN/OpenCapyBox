      ...
      {modelDrawerOpen ? (
        <>
          ...
          <form className="admin-model-drawer" onSubmit={handleSaveModel}>
            ...
            <label className="admin-model-field">Reasoning<select value={modelForm.reasoning_format} onChange={(event) => setModelForm((prev) => ({ ...prev, reasoning_format: event.target.value }))}><option value="none">none</option><option value="reasoning_content">reasoning_content</option><option value="reasoning">reasoning（vLLM）</option><option value="reasoning_details">reasoning_details</option><option value="anthropic_thinking">anthropic_thinking</option></select></label>
