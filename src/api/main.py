...
from src.api.routes import admin_usage as admin_usage_routes
...
app.include_router(admin_usage_routes.router, prefix=f"{settings.api_prefix}/admin", tags=["管理后台使用报表"])
app.include_router(
